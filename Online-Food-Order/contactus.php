...
<html>
  ...
  <head>
    <title> Contact | Food Ordering </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Food Ordering </span>?</strong>
     <br>
    Please fill the Contact Form below to get in touch with us
    </div>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <button onclick="myFunction()" class="btn btn-primary pull-right">Submit</button>  
        </form>
