<html>
  ...
  <head>
    <title> Admin Signup | Food Ordering </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
    <h2>Hi Admin,<br> Welcome to <span class="edit"> Food Ordering </span></h2>
     <br>
   <p>Get Started by creating account.</p>
    </div>
    </div>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="admin_registered_success.php" method="POST">
