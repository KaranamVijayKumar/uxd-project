...
<html>
  ...
  <head>
    <title> College Food Ordering </title>
  </head>
...
?>
    ...
    <div class="wide">
        ...
        <div><h1>Online College Food Ordering</h1></div>
        <h3><p style="text-align:center">Welcome!</h2><br>
        <p style="text-align:center"><a class="btn btn-success btn-lg" href="customersignup.php" role="button" >Order Now </a></p>
